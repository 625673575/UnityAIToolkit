...
public class DragAndDropManipulator : PointerManipulator
{
    ...
    TextElement dropLabel;
    // The stored asset object, if any.
    Object droppedObject = null;
    // The path of the stored asset, or the empty string if there isn't one.
    string assetPath = string.Empty;
    System.Action<string> m_onPerformDrop;

    public DragAndDropManipulator(VisualElement root, System.Action<string> onPerformDrop)
    {
        ...
        target = root;
        dropLabel = (root as TextElement);
        if (dropLabel == null)
        {
            Debug.LogError($"{root.name} is not a TextElement");
        };
        m_onPerformDrop = onPerformDrop;
    }
    ...
    void OnPointerDown(PointerDownEvent _)
    {
        ...
        if (droppedObject != null)
        {
            ...
            DragAndDrop.objectReferences = new Object[] { droppedObject };
    ...
    void OnDragPerform(DragPerformEvent _)
    {
        ...
        if (!string.IsNullOrEmpty(assetPath))
            m_onPerformDrop?.Invoke(assetPath);
